  ...
  },
  {
    ...
    opts = {
      ...
      custom_highlights = {
        ...
        BlinkCmpLabelDetail = { fg = "#d39f2b" },
        -- BlinkCmpKindKeyword = { fg = "#d39f2b", bg = "#8c00bf" },
        -- BlinkCmpLabel = { fg = "#d39f2b" },
        ...
        SnacksPickerPrompt = { fg = "#d39f2b" },
        SnacksPickerBoxTitle = { fg = "#d39f2b" },
        SnacksPickerTitle = { fg = "#d39f2b" },
        SnacksInputTitle = { fg = "#d39f2b" },
        -- SnacksPickerDir = { fg = "#fffff0" },
        SnacksPickerFile = { fg = "#fffff0" },
