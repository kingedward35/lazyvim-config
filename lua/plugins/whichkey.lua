...
function M.config()
  ...
  local mappings = {
    ...
    --     c = { "<cmd>Telescope git_commits<cr>", "Checkout commit" },
    { "<leader>l", group = "LSP" },
    { "<leader>lc", group = "Code Action", "<cmd>lua require('fzf-lua').lsp_code_actions()<cr>" },
    { "<leader>ld", group = "Document Diagnostics", "<cmd>lua require('fzf-lua').diagnostics_document()<cr>" },
    { "<leader>lw", group = "Workspace Diagnostics", "<cmd>lua require('fzf-lua').diagnostics_workspace()<cr>" },
    ...
    { "<leader>ls", group = "Document Symbols", "<cmd>lua require('fzf-lua').lsp_document_symbols()<cr>" },
    { "<leader>lS", group = "Workspace Symbols", "<cmd>lua require('fzf-lua').lsp_workspace_symbols()<cr>" },
